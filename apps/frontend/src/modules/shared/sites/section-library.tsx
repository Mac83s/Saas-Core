    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field>
            <FieldLabel htmlFor="section-industry">{t("industry")}</FieldLabel>
            <NativeSelect
              id="section-industry"
              value={industry}
              onChange={(event) => {
          ...
          <Field>
            <FieldLabel htmlFor="section-category">{t("category")}</FieldLabel>
            <NativeSelect
              id="section-category"
              value={blockType}
              onChange={(event) => {
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {templates.map((template) => (
            ...
            >
              ...
              <h3 className="font-semibold">{template.labels[locale].name}</h3>
        ...
        {selected && (
          <section
            ...
            tabIndex={-1}
          >
            <h3 className="font-semibold">{selected.labels[locale].name}</h3>
