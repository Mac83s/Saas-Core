...
#: What the farm register adds to core's global roles. Organization types with
#: roles of their own grant these in their catalogue instead (ADR-050).
ROLE_PERMISSIONS = {
    "viewer": ("farms.read",),
    "staff": ("farms.read",),
    "manager": ("farms.read", "farms.manage"),
    "admin": ("farms.read", "farms.manage"),
    "owner": ("farms.read", "farms.manage"),
}
...
class Migration(migrations.Migration):
    dependencies = [
        ("farms", "0003_publish_farms_feature"),
