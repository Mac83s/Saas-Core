...
RELATION_TABLES = ("farms_animal",)

CREATE_FUNCTION = """
CREATE OR REPLACE FUNCTION farms_validate_tenant_relations()
RETURNS trigger AS $$
DECLARE
...
def create_guards() -> str:
    triggers = "\n".join(
        ...
        "FOR EACH ROW EXECUTE FUNCTION farms_validate_tenant_relations();"
...
def drop_guards() -> str:
    ...
    return f"{triggers}\nDROP FUNCTION IF EXISTS farms_validate_tenant_relations();"
