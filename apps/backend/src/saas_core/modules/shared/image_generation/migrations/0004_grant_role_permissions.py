...
#: Those who already manage the site's media; `media.manage` is checked beside it.
ROLE_PERMISSIONS = {
    "manager": ("image_generation.run",),
    "admin": ("image_generation.run",),
    "owner": ("image_generation.run",),
}
