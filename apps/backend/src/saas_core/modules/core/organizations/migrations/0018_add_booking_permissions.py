...
ROLE_PERMISSIONS = {
    "viewer": ("booking.appointment.read",),
    "staff": ("booking.appointment.read",),
    "manager": ("booking.appointment.read", "booking.appointment.manage"),
    "admin": ("booking.appointment.read", "booking.appointment.manage"),
    "owner": ("booking.appointment.read", "booking.appointment.manage"),
}
...
class Migration(migrations.Migration):
    dependencies = [("organizations", "0017_alter_organizationauditentry_action")]
    operations = [
