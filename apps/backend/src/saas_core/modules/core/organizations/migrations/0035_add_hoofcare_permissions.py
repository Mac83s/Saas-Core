...
#: One permission pair for the whole herd — farms, animals and their visits are
#: one job, and a trimming company does not staff them separately. Splitting it
#: per table would be a permission matrix nobody configures and everybody grants
#: in full.
ROLE_PERMISSIONS = {
    "viewer": ("hoofcare.herd.read",),
    "staff": ("hoofcare.herd.read",),
    "manager": ("hoofcare.herd.read", "hoofcare.herd.manage"),
    "admin": ("hoofcare.herd.read", "hoofcare.herd.manage"),
    "owner": ("hoofcare.herd.read", "hoofcare.herd.manage"),
}
