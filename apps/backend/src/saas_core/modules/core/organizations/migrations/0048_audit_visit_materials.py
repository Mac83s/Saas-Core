        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("inventory.category.created", "Dodano kategorię magazynu"),
                    ("inventory.category.updated", "Zmieniono kategorię magazynu"),
                    ("inventory.category.deleted", "Usunięto kategorię magazynu"),
                    ("inventory.location.created", "Dodano magazyn"),
                    ("inventory.location.updated", "Zmieniono magazyn"),
                    ("inventory.supplier.created", "Dodano dostawcę"),
                    ("inventory.supplier.updated", "Zmieniono dostawcę"),
                    ("inventory.document.posted", "Zatwierdzono dokument magazynowy"),
                    ("inventory.document.corrected", "Skorygowano dokument magazynowy"),
                    ...
                    ("booking.appointment.completed", "Zakończono wizytę"),
                    ("booking.appointment.materials_changed", "Zmieniono produkty wizyty"),
