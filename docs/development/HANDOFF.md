...
| `saas-core-site-studio-templates`, `saas-core-site-studio-rich-content-and-full-width` | Site Studio: szablony, warianty, bogata treść | bogata treść, pełna szerokość, wygląd strony i 3 strony demonstracyjne scalone 23.09 (`docs/architecture/site-rich-content.md`); dalej edytor WYSIWYG i faza 3 — szablony nastawione na konwersję |
...
- **Limit podstron `pages.max`** — nieegzekwowany; faza 4 planu panelu.
...
- **Site Studio:** szablony pod konwersję (reguły w skillu `develop-sites`),
  ...
  v2. Realne doręczenie zapytań ze strony przez SMTP nieudowodnione.
