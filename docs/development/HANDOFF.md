...
- **Rezerwacje:** wizyta bez rezerwacji obsługuje jeden wymagany zasób
  (`shared/booking/services.py:340`). Ustawienia › Usługi i grafik nadal
  dodają pracownika i godziny starym formularzem obok karty osoby — do
  przebudowy z edycją usługi w fazie 3 zespołu.
