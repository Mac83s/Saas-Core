...
- produkcyjny runtime wywołuje modele przez provider-neutralny port. Pierwszy
  adapter może użyć OpenAI Responses API do wieloturowej rozmowy i function
  calling; wybór konkretnego modelu jest konfiguracją i podlega ewaluacjom;
...
- ADR-021, ADR-024, ADR-027, ADR-029 i ADR-030.
